...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const renderServices = () => `
    <div class="admin-header"><h1 class="admin-title-h1">Správa služeb a cen</h1></div>
    <div class="admin-card">
      <table class="admin-table">
        <thead><tr><th>Služba</th><th>Cena za m²</th><th>Stav</th><th>Akce</th></tr></thead>
        <tbody>
          <tr><td>Čištění střech</td><td>190 Kč</td><td>Aktivní</td><td>✏️</td></tr>
          <tr><td>Čištění fasád</td><td>150 Kč</td><td>Aktivní</td><td>✏️</td></tr>
          <tr><td>Zámková dlažba</td><td>120 Kč</td><td>Aktivní</td><td>✏️</td></tr>
          <tr><td>Fotovoltaika</td><td>80 Kč</td><td>Aktivní</td><td>✏️</td></tr>
        </tbody>
      </table>
    </div>
  `;
